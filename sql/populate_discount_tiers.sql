...
VALUES
  ...
  ('TIER_50K_4Y', 'Entry - 4 Year', 50000, 99999, 4, 0.10, 'Entry level commit, 4 year term (same as 3yr)', '2024-01-01'),
  ('TIER_50K_5Y', 'Entry - 5 Year', 50000, 99999, 5, 0.10, 'Entry level commit, 5 year term (same as 3yr)', '2024-01-01'),
  ...
  ('TIER_100K_4Y', 'Standard - 4 Year', 100000, 249999, 4, 0.18, 'Standard commit, 4 year term (same as 3yr)', '2024-01-01'),
  ('TIER_100K_5Y', 'Standard - 5 Year', 100000, 249999, 5, 0.18, 'Standard commit, 5 year term (same as 3yr)', '2024-01-01'),
  ...
  ('TIER_250K_4Y', 'Growth - 4 Year', 250000, 499999, 4, 0.25, 'Growth commit, 4 year term (same as 3yr)', '2024-01-01'),
  ('TIER_250K_5Y', 'Growth - 5 Year', 250000, 499999, 5, 0.25, 'Growth commit, 5 year term (same as 3yr)', '2024-01-01'),
  ...
  ('TIER_500K_4Y', 'Scale - 4 Year', 500000, 999999, 4, 0.30, 'Scale commit, 4 year term (same as 3yr)', '2024-01-01'),
  ('TIER_500K_5Y', 'Scale - 5 Year', 500000, 999999, 5, 0.30, 'Scale commit, 5 year term (same as 3yr)', '2024-01-01'),
  ...
  ('TIER_1M_4Y', 'Enterprise - 4 Year', 1000000, 4999999, 4, 0.35, 'Enterprise commit, 4 year term (same as 3yr)', '2024-01-01'),
  ('TIER_1M_5Y', 'Enterprise - 5 Year', 1000000, 4999999, 5, 0.35, 'Enterprise commit, 5 year term (same as 3yr)', '2024-01-01'),
  ...
  ('TIER_5M_4Y', 'Strategic - 4 Year', 5000000, NULL, 4, 0.40, 'Strategic commit, 4 year term (same as 3yr)', '2024-01-01'),
  ('TIER_5M_5Y', 'Strategic - 5 Year', 5000000, NULL, 5, 0.40, 'Strategic commit, 5 year term (same as 3yr)', '2024-01-01');
