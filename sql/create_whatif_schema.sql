...
-- ============================================================================
CREATE TABLE IF NOT EXISTS IDENTIFIER({{catalog}} || '.' || {{schema}} || '.discount_tiers') (
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS IDENTIFIER({{catalog}} || '.' || {{schema}} || '.discount_scenarios') (
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_burndown') (
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_forecast') (
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_summary') (
...
-- ============================================================================
CREATE OR REPLACE VIEW IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_comparison') AS
SELECT
  s.scenario_id,
  s.contract_id,
  s.scenario_name,
...
FROM IDENTIFIER({{catalog}} || '.' || {{schema}} || '.discount_scenarios') s
INNER JOIN IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_summary') sm
...
-- ============================================================================
CREATE OR REPLACE VIEW IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_burndown_chart') AS
SELECT
  sb.contract_id,
  sb.usage_date,
  s.scenario_name,
  ...
  s.is_baseline
FROM IDENTIFIER({{catalog}} || '.' || {{schema}} || '.scenario_burndown') sb
INNER JOIN IDENTIFIER({{catalog}} || '.' || {{schema}} || '.discount_scenarios') s
...
-- ============================================================================
CREATE OR REPLACE VIEW IDENTIFIER({{catalog}} || '.' || {{schema}} || '.sweet_spot_recommendation') AS
SELECT
  contract_id,
  scenario_id,
  scenario_name,
