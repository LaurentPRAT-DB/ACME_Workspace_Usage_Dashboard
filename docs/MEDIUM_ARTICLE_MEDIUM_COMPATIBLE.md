...
![The Problem and Solution](https://raw.githubusercontent.com/LaurentPRAT-DB/ACME_Workspace_Usage_Dashboard/main/docs/images/problem_solution.png)
...
**Architecture Overview** — For Technical Leads — *5 min read*

**Quick Start Installation** — For Administrators — *15 min read*

**Deep Dive: The SQL** — For Developers — *20 min read*

**What-If Analysis** — For FinOps, Procurement — *10 min read*
...
**OVERSPENDING**
- Contract: $500K → Used: $550K
- Impact: $50K overage at LIST PRICE + lost negotiating power

**UNDERSPENDING**
- Contract: $500K → Used: $350K
- Impact: $150K wasted commitment — money gone forever
...
![Dashboard Pages Overview](https://raw.githubusercontent.com/LaurentPRAT-DB/ACME_Workspace_Usage_Dashboard/main/docs/images/dashboard_pages.png)
*Five dashboard pages organized by persona: Executive, Operations, and Finance views*

### ROI Example

**Without Monitor:**
- Discovered over-pace 60 days late
- Paid $50K overage at list price
- Renewed at same 10% discount
- **Total Cost: $550K**

**With Monitor:**
- Alerted within 7 days
- Adjusted usage, stayed in contract
- Negotiated 15% with usage data
- **Total Cost: $425K**
- **Savings: $125K**
...
**Daily Refresh** — Runs at 2 AM daily — Pulls new billing data

**Weekly Training** — Runs Sunday 3 AM — Retrains Prophet ML model

**Weekly Review** — Runs Monday 8 AM — Generates operational reports

**Monthly Summary** — Runs 1st of month — Archive and executive summary
...
![Data Flow Architecture](https://raw.githubusercontent.com/LaurentPRAT-DB/ACME_Workspace_Usage_Dashboard/main/docs/images/architecture.png)
...
![Contract Burndown with ML Forecast](https://raw.githubusercontent.com/LaurentPRAT-DB/ACME_Workspace_Usage_Dashboard/main/docs/images/contract_burndown_predict.png)
...
![Sweet Spot Analysis](https://raw.githubusercontent.com/LaurentPRAT-DB/ACME_Workspace_Usage_Dashboard/main/docs/images/sweet_spot.png)
...
**Executive:** Start with `docs/executive/EXECUTIVE_SUMMARY.md`

**Administrator:** Start with `docs/administrator/ADMIN_GUIDE.md`

**Developer:** Start with `docs/developer/TECHNICAL_REFERENCE.md`

**FinOps:** Start with `docs/executive/CONTRACT_OPTIMIZATION_STRATEGY.md`
